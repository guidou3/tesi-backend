...
public class BPMNGraphVisualizer {

    protected BPMNGraphVisualizer() {
    };

    private static BPMNGraphVisualizer instance = null;

    public static BPMNGraphVisualizer instance() {
        if (instance == null) {
            instance = new BPMNGraphVisualizer();
        }
        return instance;
    }
    ...
    public ProMJGraph visualizeGraphWithoutRememberingLayout(DirectedGraph<?, ?> graph) {
    ...
    public ProMJGraph visualizeGraph(PluginContext context, DirectedGraph<?, ?> graph) {
        return visualizeGraph(findConnection(context, graph), context, graph, new ViewSpecificAttributeMap());
    }

    public ProMJGraph visualizeGraph(PluginContext context, DirectedGraph<?, ?> graph, ViewSpecificAttributeMap map) {
