...
//import org.processmining.Guido.DataAwareConformanceChecking.GroupedTraces.GroupedTrace;
...
// * @param <T>
// */
//abstract public class AbstractBalancedDataConformancePlugin<L, T> {
//
...
//
//    abstract protected L preparePluginResult(DataPetriNet net, XLog log, DataConformancePlusConfiguration config,
//                                             List<T> dataAlignmentResults, long usedTime, AtomicDouble sumFitness);
//
//    abstract protected T convertAlignmentResult(BalancedDataAlignmentState state, AtomicDouble sumFitness);
//
...
//    }
//
//    protected L doBalancedDataConformanceChecking(final DataPetriNet net, final Collection<XTrace> traces,
...
//                    }
//
//                    List<T> alignmentResults = gatherFutureResults(observer, groupedTraces, dataAlignmentFutures,
//                            expandedResults, expandedIndicies);
//
//                    stopwatch.stop();
//                    long usedTime = stopwatch.elapsed(TimeUnit.SECONDS);
//
//                    L result = preparePluginResult(net, log, config, alignmentResults, usedTime, sumFitness);
//
...
//    private List<T> gatherFutureResults(DataConformancePlusObserver observer, final GroupedTraces groupedTraces,
...
//        List<T> alignmentResults = new ArrayList<>(expandedResults.length);
//
...
//                            alignmentResults.add((T) expandedResults[i]);
//                        }
